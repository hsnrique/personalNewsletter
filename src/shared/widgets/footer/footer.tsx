      ...
      <div className='w-[95%] md:flex m-auto py-5'>
        <div className="w-full md:w-[40%]">
          ...
          <p className='text-2xl py-3'>
            Get Nletterly updates delivered directly to your inbox.
          </p>
          <div className="flex items-center w-full">
            ...
            />
            <button className='w-[90px] cursor-pointer rounded-r h-[43px] bg-[#3f48d1] text-xl outline-none'>
              submit
            </button>
          </div>
          <br />
          <p className="text-xs">
            By subscribind you agree to with our Privacy Policy and provide consent to receive updates from our company.
          </p>
        </div>
        <div className="w-full md:w-[60%] flex md:justify-end justify-center py-5 md:py-0">
          <div className="md:w-[50%] flex justify-around">
            ...
            {/* I'm creating clerk project, one minute please */}
            <div>
              <ul>
