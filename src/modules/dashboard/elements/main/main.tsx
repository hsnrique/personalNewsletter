...
const Main = () => {
  ...
  return (
    <div className="p-5 w-full h-screen bg-[#f9fafb]">
      ...
      <p className="opacity-[.7] text-sm pt-2 pb-5">
        ...
        <div className="w-[35%] p-5">
          ...
          <div>
            ...
            <div className="w-full bg-white border rounded p-5 my-3">
              ...
              <div>
                ...
                <div className="w-full px-2 my-1 h-[38px] bg-transparent border rounded-lg relative flex items-center cursor-pointer" onClick={handleCopyClick}>
                  <small className={`w-[70%] text-sm overflow-hidden overflow-ellipsis whitespace-nowrap copy-text ${copied ? "bg-blue-200" : "bg-transparent"}`}>
                    {process.env.NEXT_PUBLIC_WEBSITE_URL}/subscribe?username={user?.username}
                  </small>
                  <div className="absolute h-[38px] w-[90px] rounded-r-lg bg-[#cfd2fa] right-0 flex items-center justify-center">
          ...
          <div className="w-full bg-white border rounded p-5 my-3">
            ...
            <p className="text-sm opacity-[.7]">
              Learn how to get started on nlet and utilize all our features,
              directly from the nletterly team.
            </p>
            <br />
            <Button className="bg-[#cfd2fa] text-[#3f48d1] rounded-lg h-[35px] flex items-center">
