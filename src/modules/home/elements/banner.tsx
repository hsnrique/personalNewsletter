    ...
    <div className="bg-[#f7f5ff] h-[95vh]">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute">
          <h1 className="uppercase font-[800] text-black text-[2.75rem] md:text-[7xl] lg:text-[4rem] xl:text-[5.75rem] max-w-4xl mx-auto text-center z-10">
            THE NEWSLETTER PLATFORM BUILT FOR&nbsp;
            <span className="font-style text-[#3f48d1]">GROWTH.</span>
          </h1>
          <br />
          <h3 className="text-3xl text-center text-black">Built by newsletter people</h3>
          <br />
          ...
          <br />
          <h5 className="text-center text-lg text-black">start a 30 day free trial</h5>
        </div>
      </div>
    </div>
  )
